...
{
    [RoutePrefix("api/Destaque")]
    public class DestaqueController : ApiController
    {
        private readonly IProdutoService _produtoService;

        public DestaqueController(IProdutoService produtoService)
        {
        ...
        public async Task<HttpResponseMessage> Get()
        {
            try
            {
                var result = await _produtoService.Destaques();
